...
#/-- 아무 값이나 INSERT 해보기 --/
INSERT INTO post (author, title, content, createdAt) VALUES ('Haely Kim', 'our sopt', 'sopt server fighting~~~!!', '5/20/2020');
...
UPDATE post SET createdAt='05/20/2020' WHERE postIdx = 2;
